...
namespace LibraryManagementApi.Controllers.Identity
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public readonly LibraryDbContext db;
        public AccountController(UserManager<IdentityUser> userManager, IConfiguration config, LibraryDbContext db)
        {
